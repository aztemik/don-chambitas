...
| 2026-09-23 | S2-T05 | BCJL | feat/S2-T05-viewmodels-estados-ui-autenticacion |  | Tres ViewModels de autenticacion con StateFlow y RepositorioAuth: P-02 y P-03 conectadas a la fuente falsa, P-04 preparada para S2-T10, carga sin doble envio, errores, reintentos y destinos de un solo uso. 72 pruebas unitarias y 27 instrumentadas pasan en Pixel 10. Desarrollada desde main mientras S2-T04 permanece en revision, sin depender de su codigo |
