...
| 2026-09-23 | S2-T04 | GRI | feat/S2-T04-validaciones-formularios |  | Las 12 reglas de la tabla 5.2 en dominio/validacion/ValidacionesAuth.kt, Kotlin puro y con la misma expresion del correo que el esquema. P-02 y P-03 validan al salir de un campo ya escrito y al enviar, marcan todos los fallos y llevan el foco al primero. **Desvio de la seccion 5:** las reglas devuelven FalloValidacion y la ui lo traduce a R.string, porque el dominio no puede conocer R. LimitesRegistro pasa al dominio. 29 pruebas unitarias nuevas; 31 instrumentadas de P-02 y P-03 pasando. **Hallazgo:** 2 pruebas de SplashViewModelTest fallan tambien sin esta tarea (carrera entre el init del ViewModel y la prueba) |
